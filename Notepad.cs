...
namespace SIClientImport
{
    ...
    {
        public bool ValidateNotepad(DataTable dtSpreadsheet, string strDateFormat)
        {
            bool _overallValidation = true;
            bool isValid;
            string dateString;
            int rowcount = 0;
            Form1.dtFinalLoad = BuildFinalNotepadTable(dtSpreadsheet);
            if (Form1.dtFinalLoad == null)
            {
                return false;
            }
            if (Form1.dtFinalNotepadLoad == null)
            {
                Form1.dtFinalNotepadLoad = Form1.dtFinalLoad.Clone();
            }
        ...
        public static DataTable BuildFinalNotepadTable(DataTable dt)
        {
            ...
            dtFinal.Columns[1].DataType = System.Type.GetType("System.Guid");//NotepadID
            dtFinal.Columns[2].DataType = System.Type.GetType("System.Int32");//ClaimantID
            dtFinal.Columns[3].DataType = System.Type.GetType("System.Int32");//NotepadTypeID
            dtFinal.Columns[4].DataType = System.Type.GetType("System.String");//Subject
            dtFinal.Columns[5].DataType = System.Type.GetType("System.String");//Content
            ...
            dtFinal.Columns[8].DataType = System.Type.GetType("System.String");//EnteredBy
            dtFinal.Columns[9].DataType = System.Type.GetType("System.String");//UpdatedBy
            dtFinal.Columns[10].DataType = System.Type.GetType("System.String");//RoleName
            dtFinal.Columns[11].DataType = System.Type.GetType("System.Int32");//ClaimID
            dtFinal.Columns[12].DataType = System.Type.GetType("System.Boolean");//HasAttachment
            dtFinal.Columns[13].DataType = System.Type.GetType("System.Int32");//ClaimantCoverageID
            dtFinal.Columns[14].DataType = System.Type.GetType("System.Boolean");//IsClaimLevel
            dtFinal.Columns[15].DataType = System.Type.GetType("System.Int32");//StatusID

            if (dtFinal.Columns[15].ColumnName != "StatusId")
                {
